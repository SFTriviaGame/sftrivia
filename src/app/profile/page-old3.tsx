...
export default function ProfilePage() {
  ...
  const earnedTitles = titles?.earned || [];
              ...
              <div className="space-y-4">
                {earnedTitles.map((title, i) => (
                  <div key={i} className="relative flex items-start gap-3">
                    {/* Dot on the line */}
                    <div
                      className="absolute -left-4 top-1.5 w-[9px] h-[9px] rounded-full border-2"
                      style={{
                        borderColor: title.isDisplayed ? "#b45309" : "rgba(0,0,0,0.15)",
                        background: title.isDisplayed ? "#b45309" : "#FAFAF8",
                      }}
                    />
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          style={{
                            ...
                            color: title.isDisplayed ? "#b45309" : "#252018",
                          }}
                        >
                          {title.name}
                        </span>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-xs" style={{ color: "#a3a3a3" }}>
                          {TITLE_TYPE_LABELS[title.titleType || "genre"] || title.titleType}
                        </span>
                        {title.earnedAt && (
                          <>
                            <span className="text-xs" style={{ color: "#d5d0c7" }}>&middot;</span>
                            <span className="text-xs" style={{ color: "#a3a3a3" }}>
                              {new Date(title.earnedAt).toLocaleDateString("en-US", {
                                month: "short",
                                day: "numeric",
                                year: "numeric",
                              })}
