...
export default function ProfilePage() {
  ...
  const { stats, headline, genreRadar, history, badges } = profile;
  ...
  return (
    <div
      ...
      style={{ background: "#FAFAF8", color: "#252018" }}
    >
      <div className="max-w-xl mx-auto px-5 py-8">
        ...
        <section className="grid grid-cols-4 gap-3 text-center">
          {[
            ...
            {
              label: "Best",
              value: headline.best > 0 ? headline.best.toLocaleString() : "—",
            },
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {badges.all.map((badge) => {
              ...
              const earnedBadge = badges.earned.find(
                (b) => b.name === badge.name
              );
              ...
              return (
                <div
                  ...
                  style={{
                    background: isEarned ? style.bg : "rgba(0,0,0,0.02)",
                    border: `1px solid ${isEarned ? style.border : "rgba(0,0,0,0.06)"}`,
                ...
                >
                  <div className="flex items-center gap-1.5 mb-1">
                    <span
                      ...
                      style={{
                        fontFamily: "'DM Sans', sans-serif",
                        color: isEarned ? style.text : "#a3a3a3",
                      }}
                    >
                      {badge.name}
                    </span>
                  ...
                  <p
                    ...
                    style={{
                      color: isEarned ? style.text : "#a3a3a3",
                      opacity: isEarned ? 0.8 : 0.6,
                    }}
                  >
                    {badge.description}
                  </p>
                  {isEarned && earnedBadge?.earnedAt && (
                    <p className="text-xs mt-1" style={{ color: style.text, opacity: 0.5 }}>
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              {
                label: "Avg clue at guess",
                value: stats.avgClue > 0 ? stats.avgClue : "—",
              },
            ].map((row) => (
              <div
                key={row.label}
        ...
        <section>
          ...
          <p className="text-sm py-4" style={{ color: "#737373" }}>
            No titles yet. Every puzzle gets you closer.
          </p>
        </section>
          ...
          {history.length === 0 ? (
            <div className="text-center py-6">
              <p className="text-sm" style={{ color: "#737373" }}>
                Nothing here yet. Go play.
              </p>

                href="/play"
                className="inline-block mt-3 px-5 py-2.5 rounded-lg text-sm font-semibold text-white"
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        {p.date}
                        {p.solved
                          ? ` · Clue ${p.clue} of ${p.totalSongs} · ${
                              p.wrong === 0 ? "Perfect" : `${p.wrong} wrong`
                            }`
                          : " · Gave up"}
                      </div>
                    </div>
